        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-8">
          <div className="lg:col-span-6">
            <div className="text-center lg:text-left">
              ...
              <h1 className="text-4xl tracking-tight font-bold text-hubspot-dark sm:text-5xl md:text-6xl">
                With HubSpot, you <span className="italic text-gray-600">can</span> have it all
              </h1>
          ...
          <div className="mt-12 lg:mt-0 lg:col-span-6">
            <div className="relative">
              <img 
                src="https://www.hubspot.com/hubfs/assets/hubspot.com/home/platform/dashboard-2021@3x.svg" 
              ...
              <div className="absolute top-1/4 right-10 bg-white p-3 rounded-lg shadow-md">
                <div className="text-xs font-semibold text-gray-600">Annual revenue</div>
              ...
              <div className="absolute top-1/3 right-20 bg-white p-3 rounded-lg shadow-md">
                <div className="text-xs font-semibold text-gray-600">Employee range</div>
