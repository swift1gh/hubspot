        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="max-w-3xl mx-auto text-lg text-gray-500">
              ...
              some of our customers' top business challenges and learn how
              HubSpot's integrated software and solutions can help you leave
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="flex flex-wrap justify-center gap-8 mb-8">
              ...
              <div className="text-center flex items-center justify-center p-4 w-24 h-24 grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition">
                <img
                  src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/ec/Mailchimp_Logo.svg/1280px-Mailchimp_Logo.svg.png"
                  alt="Mailchimp"
                />
              </div>
              <div className="text-center flex items-center justify-center p-4 w-24 h-24 grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition">
          ...
          <div className="flex flex-wrap justify-center gap-8 mb-8">
            ...
            <div className="text-center p-4">
              <div className="bg-white shadow rounded-lg p-4 flex flex-col items-center justify-center h-36 w-40">
                <img
                  src="https://www.g2.com/shared-assets/product-badges/winter-2024/leader.svg"
            ...
            <div className="text-center p-4">
              <div className="bg-white shadow rounded-lg p-4 flex flex-col items-center justify-center h-36 w-40">
                <img
                  src="https://www.g2.com/shared-assets/product-badges/winter-2024/easiest-setup.svg"
                  alt="G2 Easiest Setup Winter 2024"
                  className="h-16 mb-2"
                />
                <p className="text-sm text-gray-600">
                  G2 Easiest Setup Winter 2024
                </p>
              </div>
            </div>
            <div className="text-center p-4">
              <div className="bg-white shadow rounded-lg p-4 flex flex-col items-center justify-center h-36 w-40">
                <img
                  src="https://www.g2.com/shared-assets/product-badges/winter-2024/best-relationship.svg"
                  alt="G2 Best Relationship Winter 2024"
                  className="h-16 mb-2"
                />
                <p className="text-sm text-gray-600">
